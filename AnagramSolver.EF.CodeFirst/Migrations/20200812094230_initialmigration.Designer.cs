...
namespace AnagramSolver.EF.CodeFirst.Migrations
{
    ...
    [Migration("20200812094230_initialmigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnagramSolver.Contracts.Entities.UserLogEntity", b =>
                {
                    b.HasOne("AnagramSolver.Contracts.Entities.CachedWordEntity", "SearchWord")
                        .WithMany()
                        .HasForeignKey("SearchWordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
